...
public class Exercise25_01 {
  ...
  public Exercise25_01() {
    ...
    BinaryTree<Integer> tree2 = new BinaryTree<Integer>(new Integer[]{50, 45, 35, 48, 59, 51, 58}); 
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public int height(TreeNode<E> para,int h) {
      if (para==null){
        return h;
      }
      
      int h1=height(para.left,h+1);
      int h2=height(para.right,h+1);
